...
export default function Home() {
  ...
  return (
    <>
              ...
              <div className="p-8">
                {status === 'success' ? (
                  ...
                  >
                    ...
                    <p className="text-gray-600">We&apos;ll notify you when Oath launches.</p>
                  </motion.div>
                ) : (
                  <>
                    <div className="text-center mb-6">
                      <h3 className="text-2xl font-bold text-gray-900 mb-2">Join the Waitlist</h3>
                      <p className="text-gray-600">Be the first to know when Oath launches.</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      <div>
                        ...
                        <input
                          ...
                          required
                          placeholder="John"
                          className="w-full px-4 py-3 rounded-xl border border-gray-300 bg-white text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all"
                        />
                      </div>
      ...
      <main>
        {/* Hero Section */}
        <section className="relative min-h-[100dvh] flex items-center justify-center bg-white overflow-hidden py-20 sm:py-0">
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
            ...
            <div className="-translate-y-8 sm:-translate-y-12">
              ...
              >
                <span className="inline-block text-sm font-medium text-emerald-600 mb-4 sm:mb-8">
              ...
              <motion.h1
                ...
                className="text-4xl sm:text-5xl md:text-7xl font-bold text-gray-900 mb-4 sm:mb-8 tracking-tight text-center"
              >
                Your Word. Your Oath.
              </motion.h1>
              ...
              <motion.p
                ...
                className="text-[15px] sm:text-xl md:text-2xl text-gray-600 leading-relaxed text-center sm:max-w-2xl mx-auto box-border"
                style={{ maxWidth: 'min(672px, 100%)' }}
              >
                  ...
                  <div key={setIndex} className="flex gap-4 flex-shrink-0">
                      ...
                      >
                        ...
                        <div className="flex-1 px-[14px] py-[12px] text-left">
                          <div className="flex items-center gap-2 mb-2">
                            <span className="text-[11px] font-bold tracking-wide text-gray-500 uppercase">Today</span>
                          ...
                          <p className="text-[16px] font-bold text-gray-900 mb-2">Complete quarterly report</p>
                    ...
                    <div className="flex-shrink-0 w-[290px]">
                      ...
                      >
                        ...
                        <div className="flex-1 px-[14px] py-[12px] text-left">
                          <div className="flex items-center gap-2 mb-2">
                            <span className="text-[11px] font-bold tracking-wide text-gray-500 uppercase">Tomorrow</span>
                            <span className="flex items-center gap-1 px-1.5 py-0.5 rounded text-[10px] font-semibold" style={{ backgroundColor: 'rgba(15, 170, 119, 0.12)', color: '#0FAA77' }}>
                              <svg className="w-[9px] h-[9px]" fill="currentColor" viewBox="0 0 20 20">
                                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                              </svg>
                          ...
                          <p className="text-[16px] font-bold text-gray-900 mb-2">Morning run - 5K</p>
                          <div className="flex items-center justify-between">
                    ...
                    <div className="flex-shrink-0 w-[290px]">
                      ...
                      >
                        ...
                        <div className="flex-1 px-[14px] py-[12px] text-left">
                          ...
                          <p className="text-[16px] font-bold line-through text-gray-400 mb-2">Schedule dentist appointment</p>
                          <div className="flex items-center justify-between">
                    ...
                    <div className="flex-shrink-0 w-[290px]">
                      ...
                      >
                        ...
                        <div className="flex-1 px-[14px] py-[12px] text-left">
                          <div className="flex items-center gap-2 mb-2">
                            <span className="text-[11px] font-bold tracking-wide text-gray-500 uppercase">Friday</span>
                            <span className="flex items-center gap-1 px-1.5 py-0.5 rounded text-[10px] font-semibold" style={{ backgroundColor: 'rgba(15, 170, 119, 0.12)', color: '#0FAA77' }}>
                              <svg className="w-[9px] h-[9px]" fill="currentColor" viewBox="0 0 20 20">
                                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                              </svg>
                          ...
                          <p className="text-[16px] font-bold text-gray-900 mb-2">Review monthly budget</p>
                          <div className="flex items-center justify-between">
        ...
        <section id="features" className="py-32 bg-gray-50">
          <div className="max-w-6xl mx-auto px-6">
            ...
            >
              ...
              <p className="text-xl text-gray-600" style={{ textAlign: 'center' }}>
            ...
            <div className="space-y-24">
              ...
              >
                <div className="order-2 md:order-1">
                  <span className="text-sm font-semibold text-emerald-600 mb-4 block">Step 1</span>
                  <h3 className="text-3xl font-bold text-gray-900 mb-4">Create</h3>
              ...
              >
                ...
                <div>
                  <span className="text-sm font-semibold text-emerald-600 mb-4 block">Step 2</span>
                  <h3 className="text-3xl font-bold text-gray-900 mb-4">Get Reminded</h3>
                  <p className="text-lg text-gray-600 leading-relaxed">
              ...
              >
                <div className="order-2 md:order-1">
                  <span className="text-sm font-semibold text-emerald-600 mb-4 block">Step 3</span>
                  <h3 className="text-3xl font-bold text-gray-900 mb-4">Honor</h3>
                  <p className="text-lg text-gray-600 leading-relaxed">
        ...
        <section className="py-32 bg-gray-50">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              >
                <div className="mb-6">
                  <span className="text-sm text-gray-500">Simple task</span>
                  <p className="text-xl font-semibold text-gray-900 mt-1">&quot;Take out trash 8 PM&quot;</p>
                </div>
              ...
              >
                <div className="mb-6">
                  <span className="text-sm text-gray-500">Complex task</span>
                  <p className="text-xl font-semibold text-gray-900 mt-1">&quot;Quarterly report Friday 5 PM&quot;</p>
                </div>
                {/* Light mode container */}
                <div
        ...
        <section id="waitlist" className="py-32 bg-gray-50">
          ...
          >
            ...
            <p className="text-xl text-gray-600" style={{ marginBottom: '2.25rem' }}>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              <input
                ...
                className="flex-1 px-6 py-4 rounded-full border border-gray-300 bg-white text-gray-900 placeholder-gray-500 outline-none ring-0 focus:border-[#BFA35A] transition-colors disabled:opacity-50"
